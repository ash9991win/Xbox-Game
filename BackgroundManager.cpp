...
void BackgroundManagerC::update(DWORD newMS)
{
	...
	mTextureCoordinates.width = /*screenSize.x / IMAGE_WIDTH*/ CAMERA_WIDTH;
	mTextureCoordinates.height = /*screenSize.y / IMAGE_HEIGHT*/CAMERA_HEIGHT;
}
