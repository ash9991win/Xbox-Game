...
#if defined(_WIN32)
    #define FSBANK_EXPORT __declspec(dllexport) _stdcall
    #define FSBANK_CALLBACK _stdcall
#elif defined(__linux__) || defined(__MACH__)
    #define FSBANK_EXPORT __attribute__ ((visibility("default")))
    #define FSBANK_CALLBACK
#else
    #define FSBANK_EXPORT
    #define FSBANK_CALLBACK
#endif

#if defined(DLL_EXPORTS)
    #define FB_API FSBANK_EXPORT
#else
    #define FB_API
#endif
