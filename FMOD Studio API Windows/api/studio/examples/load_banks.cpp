...
FMOD_RESULT loadFile(const char* filename, char** memoryBase, char** memoryPtr, int* memoryLength)
{
    ...
    // Load into a pointer aligned to 32
    char* membase = reinterpret_cast<char*>(malloc(length + 32));
    char* memptr = (char*)(((size_t)membase + (32-1)) & ~(32-1));
...
//
FMOD_RESULT F_API studioCallback(FMOD_STUDIO_SYSTEM *system, FMOD_STUDIO_SYSTEM_CALLBACK_TYPE type, void *commanddata, void *userdata)
{
